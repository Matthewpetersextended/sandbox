...
import { ArrowRight, CheckCircle, MessageSquare, Zap, Shield, Users } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const handleSignIn = () => {
    // Route to your existing sign in page, then redirect to tools after auth
    router.push('/sign-in?redirect=/tools');
  };
  ...
  const features = [
    {
      ...
      description: "Streamline student support with powerful tools to create, track, and organize IEPs with ease."
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Lesson & Document Planning",
      description: "Simplify lesson prep with integrated tools for planning, document creation, and presentations."
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Classroom & Live Lesson Tools",
      description: "Manage real-time lessons, evaluations, and student progress all in one platform."
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Collaboration & Communication",
      description: "Stay connected with students, parents, and fellow educators through built-in messaging and teamwork features."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white-200 via-white to-green-200">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                ...
                <span className="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent"> Teacher Pro's Class Managment Tools</span>
              </h1>
