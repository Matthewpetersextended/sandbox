//app/web-pages/attendance/page.tsx
...
export default function AttendancePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section - CUSTOMIZED FOR ATTENDANCE */}
      <div className="min-h-screen bg-gradient-to-r from-teal-500 to-cyan-400 flex items-center justify-center p-10">
        <div className="max-w-5xl text-white grid md:grid-cols-2 gap-12 items-center">
          
          {/* Left Content */}
          <div>
            <p className="uppercase tracking-wide text-sm font-semibold">Feature: Attendance</p>
            <h1 className="text-4xl font-bold mt-4">
              Track attendance effortlessly.<br />Never miss a <em>pattern</em>.
            </h1>
            <p className="mt-6 text-lg leading-relaxed">
              Say goodbye to paper rolls and time-consuming manual tracking. Our smart attendance 
              system makes it simple to record student presence, identify patterns, and keep parents 
              informed—all with just a few clicks. Spend less time on administration and more time 
              teaching with automated tracking that keeps everyone accountable.
            </p>

            <p className="mt-6 text-xl font-semibold">
              <span className="text-yellow-200">78%</span> of schools reported improved attendance rates 
              after implementing automated tracking and parent notifications.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 text-black">
            <div className="flex items-center justify-between mb-4">
              <p className="font-bold text-lg">Today's Attendance</p>
              <span className="text-sm bg-teal-100 text-teal-700 px-3 py-1 rounded-full font-semibold">Oct 2, 2024</span>
            </div>
            ...
            <div className="mt-4 pt-4 border-t flex items-center justify-between text-sm">
              <span className="font-medium text-gray-600">Present: 24/26</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="bg-gradient-to-r from-teal-500 to-cyan-400 rounded-2xl p-12 flex items-center justify-center min-h-[400px]">
            ...
            <div>
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-teal-500 to-cyan-400 text-white text-2xl font-bold mb-6">
                1
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center text-sm font-semibold mt-0.5">
                    1
                  </span>
                  <span className="text-lg text-gray-700 leading-relaxed">Mark attendance in seconds with our intuitive one-click interface.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center text-sm font-semibold mt-0.5">
                    2
                  </span>
                  <span className="text-lg text-gray-700 leading-relaxed">Track present, absent, late, and custom status codes with ease.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center text-sm font-semibold mt-0.5">
                    3
                  </span>
                  <span className="text-lg text-gray-700 leading-relaxed">Access attendance from any device—desktop, tablet, or smartphone.</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-lg text-gray-700 leading-relaxed">Automatically notify parents when students are absent or late.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center text-sm font-semibold mt-0.5">
                    2
                  </span>
                  <span className="text-lg text-gray-700 leading-relaxed">Identify attendance patterns and at-risk students with intelligent analytics.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center text-sm font-semibold mt-0.5">
                    3
                  </span>
                  <span className="text-lg text-gray-700 leading-relaxed">Generate comprehensive attendance reports for administration and compliance.</span>
                </li>
              </ul>
            </div>
      ...
      {/* Benefits Section */}
      <section className="px-6 py-20 bg-gradient-to-r from-teal-600 to-cyan-500">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl text-teal-100 mb-8">
                Eliminate paper attendance sheets and manual data entry. Track, analyze, and report attendance seamlessly.
              </p>
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                <div className="text-center">
                  ...
                  <div className="text-teal-100 mb-6">Saved Daily Per Class</div>
                  
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">100%</div>
                      <div className="text-teal-100 text-sm">Accuracy</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">Real-time</div>
                      <div className="text-teal-100 text-sm">Updates</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of schools using smart attendance tools to improve accountability and engagement.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/sign-up" className="bg-teal-500 text-white px-8 py-4 rounded-lg hover:bg-teal-600 transition-colors font-medium text-lg inline-flex items-center justify-center">
              Get Started Free
              <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
